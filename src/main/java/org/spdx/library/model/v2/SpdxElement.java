...
public abstract class SpdxElement extends ModelObjectV2 {
	...
	private synchronized void checkCreateAnnotations() throws InvalidSPDXAnalysisException {
		if (Objects.isNull(this.annotations)) {
			this.annotations = (Collection<Annotation>)(Collection<?>)this.getObjectPropertyValueSet(SpdxConstantsCompatV2.PROP_ANNOTATION, Annotation.class);
		}
	}
	...
	private synchronized void checkCreateRelationships() throws InvalidSPDXAnalysisException {
		if (Objects.isNull(this.relationships)) {
			this.relationships = (Collection<Relationship>)(Collection<?>)this.getObjectPropertyValueSet(SpdxConstantsCompatV2.PROP_RELATIONSHIP, Relationship.class);
		}
	}
