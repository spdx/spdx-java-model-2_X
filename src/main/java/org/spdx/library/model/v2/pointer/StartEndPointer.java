...
public class StartEndPointer extends CompoundPointer implements Comparable<StartEndPointer> {
	 ...
	 * @throws InvalidSPDXAnalysisException
	 */
	public StartEndPointer(IModelStore modelStore, String documentUri, String id, IModelCopyManager copyManager,
	...
	public @Nullable SinglePointer getEndPointer() throws InvalidSPDXAnalysisException {
		Optional<Object> retval = getObjectPropertyValue(SpdxConstantsCompatV2.PROP_POINTER_END_POINTER);
		if (!retval.isPresent()) {
			return null;
		}
	...
	public void setEndPointer(SinglePointer endPointer) throws InvalidSPDXAnalysisException {
		...
		setPropertyValue(SpdxConstantsCompatV2.PROP_POINTER_END_POINTER, endPointer);
	}
	...
	/* (non-Javadoc)
	 * @see org.spdx.library.model.compat.v2.compat.v2.pointer.CompoundPointer#_verify(java.util.List)
	 */
	@Override
