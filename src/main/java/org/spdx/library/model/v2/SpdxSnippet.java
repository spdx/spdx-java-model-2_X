...
public class SpdxSnippet extends SpdxItem implements Comparable<SpdxSnippet> {
	...
	public SpdxSnippet(IModelStore modelStore, String documentUri, String id, 
		...
		allRanges = new ModelCollection(modelStore, 
				...
				SpdxConstantsCompatV2.PROP_SNIPPET_RANGE, copyManager, StartEndPointer.class, specVersion, idPrefix);
	}
	...
	public String getType() {
		return SpdxConstantsCompatV2.CLASS_SPDX_SNIPPET;
	}
	...
	public @Nullable SpdxFile getSnippetFromFile() throws InvalidSPDXAnalysisException {
		Optional<Object> retval = getObjectPropertyValue(SpdxConstantsCompatV2.PROP_SNIPPET_FROM_FILE);
		if (!retval.isPresent()) {
			return null;
		}
	...
	public SpdxSnippet setSnippetFromFile(SpdxFile snippetFromFile) throws InvalidSPDXAnalysisException {
		...
		setPropertyValue(SpdxConstantsCompatV2.PROP_SNIPPET_FROM_FILE, snippetFromFile);
