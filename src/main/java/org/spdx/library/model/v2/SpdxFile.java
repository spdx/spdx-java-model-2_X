...
public class SpdxFile extends SpdxItem implements Comparable<SpdxFile> {
	...
	public SpdxFile(IModelStore modelStore, String documentUri, String id, 
		...
		checksums = (Collection<Checksum>)(Collection<?>)this.getObjectPropertyValueSet(SpdxConstantsCompatV2.PROP_FILE_CHECKSUM, Checksum.class);
		fileContributors = this.getStringCollection(SpdxConstantsCompatV2.PROP_FILE_CONTRIBUTOR);
	}
	...
	public String getType() {
		return SpdxConstantsCompatV2.CLASS_SPDX_FILE;
	}
	...
	protected PropertyDescriptor getNamePropertyDescriptor() {
		return SpdxConstantsCompatV2.PROP_FILE_NAME;
	}
	...
	public Optional<String> getNoticeText() throws InvalidSPDXAnalysisException {
		return getStringPropertyValue(SpdxConstantsCompatV2.PROP_FILE_NOTICE);
	}
	...
	public SpdxFile setNoticeText(@Nullable String noticeText) throws InvalidSPDXAnalysisException {
		setPropertyValue(SpdxConstantsCompatV2.PROP_FILE_NOTICE, noticeText);
		return this;
	}
	...
	public Collection<SpdxFile> getFileDependency() throws InvalidSPDXAnalysisException {
		return (Collection<SpdxFile>)(Collection<?>)this.getObjectPropertyValueSet(SpdxConstantsCompatV2.PROP_FILE_FILE_DEPENDENCY, SpdxFile.class);
	}
