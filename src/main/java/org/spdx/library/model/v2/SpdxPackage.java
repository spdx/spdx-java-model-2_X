...
public class SpdxPackage extends SpdxItem implements Comparable<SpdxPackage> {
	...
	public String getType() {
		return SpdxConstantsCompatV2.CLASS_SPDX_PACKAGE;
	}
	...
	public boolean isFilesAnalyzed() throws InvalidSPDXAnalysisException {
		Optional<Boolean> filesAnalyzed = getBooleanPropertyValue(SpdxConstantsCompatV2.PROP_PACKAGE_FILES_ANALYZED);
	...
	public Optional<String> getBuiltDate() throws InvalidSPDXAnalysisException {
		return getStringPropertyValue(SpdxConstantsCompatV2.PROP_BUILT_DATE);
	}
	...
	public void setBuiltDate(String builtDate) throws InvalidSPDXAnalysisException {
		...
		setPropertyValue(SpdxConstantsCompatV2.PROP_BUILT_DATE, builtDate);
	}
	...
	public Optional<String> getReleaseDate() throws InvalidSPDXAnalysisException {
		return getStringPropertyValue(SpdxConstantsCompatV2.PROP_RELEASE_DATE);
	}
	...
	public void setReleaseDate(String releaseDate) throws InvalidSPDXAnalysisException {
		...
		setPropertyValue(SpdxConstantsCompatV2.PROP_RELEASE_DATE, releaseDate);
	}
	...
	public Optional<String> getValidUntilDate() throws InvalidSPDXAnalysisException {
		return getStringPropertyValue(SpdxConstantsCompatV2.PROP_VALID_UNTIL_DATE);
	}
	...
	public void setValidUntilDate(String validUntilDate) throws InvalidSPDXAnalysisException {
		...
		setPropertyValue(SpdxConstantsCompatV2.PROP_VALID_UNTIL_DATE, validUntilDate);
	}
	...
	public @Nullable AnyLicenseInfo getLicenseDeclared() throws InvalidSPDXAnalysisException {
		Optional<AnyLicenseInfo> retval = getAnyLicenseInfoPropertyValue(SpdxConstantsCompatV2.PROP_PACKAGE_DECLARED_LICENSE);
		if (retval.isPresent()) {
			return retval.get();
		} else {
	...
	public Collection<Checksum> getChecksums() throws InvalidSPDXAnalysisException {
		return (Collection<Checksum>)(Collection<?>)this.getObjectPropertyValueSet(SpdxConstantsCompatV2.PROP_PACKAGE_CHECKSUM, Checksum.class);
	}
	...
	public Optional<String> getDescription() throws InvalidSPDXAnalysisException {
		return getStringPropertyValue(SpdxConstantsCompatV2.PROP_PACKAGE_DESCRIPTION);
	}
	...
	public SpdxPackage setDescription(String description) throws InvalidSPDXAnalysisException {
		setPropertyValue(SpdxConstantsCompatV2.PROP_PACKAGE_DESCRIPTION, description);
		return this;
	}
	...
	public Optional<String> getDownloadLocation() throws InvalidSPDXAnalysisException {
		return getStringPropertyValue(SpdxConstantsCompatV2.PROP_PACKAGE_DOWNLOAD_URL);
	}
	...
	public SpdxPackage setDownloadLocation(String downloadLocation) throws InvalidSPDXAnalysisException {
		...
		setPropertyValue(SpdxConstantsCompatV2.PROP_PACKAGE_DOWNLOAD_URL, downloadLocation);
		return this;
	}
	...
	public Optional<String> getHomepage() throws InvalidSPDXAnalysisException {
		return getStringPropertyValue(SpdxConstantsCompatV2.PROP_PROJECT_HOMEPAGE);
	}
	...
	public SpdxPackage setHomepage(String homepage) throws InvalidSPDXAnalysisException {
		...
		setPropertyValue(SpdxConstantsCompatV2.PROP_PROJECT_HOMEPAGE, homepage);
		return this;
	}
	...
	public Optional<String> getOriginator() throws InvalidSPDXAnalysisException {
		return getStringPropertyValue(SpdxConstantsCompatV2.PROP_PACKAGE_ORIGINATOR);
	}
	...
	public SpdxPackage setOriginator(String originator) throws InvalidSPDXAnalysisException {
		...
		setPropertyValue(SpdxConstantsCompatV2.PROP_PACKAGE_ORIGINATOR, originator);
		return this;
	}
	...
	public Optional<String> getPackageFileName() throws InvalidSPDXAnalysisException {
		return getStringPropertyValue(SpdxConstantsCompatV2.PROP_PACKAGE_FILE_NAME);
	}
	...
	public SpdxPackage setPackageFileName(String packageFileName) throws InvalidSPDXAnalysisException {
		setPropertyValue(SpdxConstantsCompatV2.PROP_PACKAGE_FILE_NAME, packageFileName);
		return this;
	}
	...
	public Optional<SpdxPackageVerificationCode> getPackageVerificationCode() throws InvalidSPDXAnalysisException {
		Optional<?> retval = getObjectPropertyValue(SpdxConstantsCompatV2.PROP_PACKAGE_VERIFICATION_CODE);
		if (!retval.isPresent()) {
	...
	public SpdxPackage setPackageVerificationCode(SpdxPackageVerificationCode verificationCode) throws InvalidSPDXAnalysisException {
		...
		setPropertyValue(SpdxConstantsCompatV2.PROP_PACKAGE_VERIFICATION_CODE, verificationCode);
		return this;
	}
	...
	public Optional<String> getSourceInfo() throws InvalidSPDXAnalysisException {
		return getStringPropertyValue(SpdxConstantsCompatV2.PROP_PACKAGE_SOURCE_INFO);
	}
	...
	public SpdxPackage setSourceInfo(String sourceInfo) throws InvalidSPDXAnalysisException {
		setPropertyValue(SpdxConstantsCompatV2.PROP_PACKAGE_SOURCE_INFO, sourceInfo);
		return this;
	}
	...
	public Optional<String> getSummary() throws InvalidSPDXAnalysisException {
		return getStringPropertyValue(SpdxConstantsCompatV2.PROP_PACKAGE_SHORT_DESC);
	}
	...
	public SpdxPackage setSummary(String summary) throws InvalidSPDXAnalysisException {
		setPropertyValue(SpdxConstantsCompatV2.PROP_PACKAGE_SHORT_DESC, summary);
		return this;
	}
	...
	public Optional<String> getSupplier() throws InvalidSPDXAnalysisException {
		return getStringPropertyValue(SpdxConstantsCompatV2.PROP_PACKAGE_SUPPLIER);
	}
	...
	public SpdxPackage setSupplier(String supplier) throws InvalidSPDXAnalysisException {
		...
		setPropertyValue(SpdxConstantsCompatV2.PROP_PACKAGE_SUPPLIER, supplier);
		return this;
	}
	...
	public Optional<String> getVersionInfo() throws InvalidSPDXAnalysisException {
		return getStringPropertyValue(SpdxConstantsCompatV2.PROP_PACKAGE_VERSION_INFO);
	}
	...
	public SpdxPackage setVersionInfo(String versionInfo) throws InvalidSPDXAnalysisException {
		setPropertyValue(SpdxConstantsCompatV2.PROP_PACKAGE_VERSION_INFO, versionInfo);
		return this;
	}
	...
	public Collection<ExternalRef> getExternalRefs() throws InvalidSPDXAnalysisException {
		return (Collection<ExternalRef>)(Collection<?>)this.getObjectPropertyValueSet(SpdxConstantsCompatV2.PROP_EXTERNAL_REF, ExternalRef.class);
	}
	...
	public Optional<Purpose> getPrimaryPurpose() throws InvalidSPDXAnalysisException {
		Optional<Enum<?>> retval = getEnumPropertyValue(SpdxConstantsCompatV2.PROP_PRIMARY_PACKAGE_PURPOSE);
	...
	public void setPrimaryPurpose(Purpose purpose) throws InvalidSPDXAnalysisException {
		setPropertyValue(SpdxConstantsCompatV2.PROP_PRIMARY_PACKAGE_PURPOSE, purpose);
	}
	
	/* (non-Javadoc)
	 * @see org.spdx.library.model.compat.v2.compat.v2.SpdxItem#_verify(java.util.List)
	 */
	@Override
	protected List<String> _verify(Set<String> verifiedIds, String specVersion) {
		...
		// license declared
		try {
			Optional<AnyLicenseInfo> declaredLicense = getAnyLicenseInfoPropertyValue(SpdxConstantsCompatV2.PROP_PACKAGE_DECLARED_LICENSE);
